...
=========================================================================================
            Conv2d-1            [-1, 1, 28, 28]          [-1, 10, 24, 24]             260
            Conv2d-2           [-1, 10, 12, 12]            [-1, 20, 8, 8]           5,020
         Dropout2d-3             [-1, 20, 8, 8]            [-1, 20, 8, 8]               0
            Linear-4                  [-1, 320]                  [-1, 50]          16,050
            Linear-5                   [-1, 50]                  [-1, 10]             510
               Net-6            [-1, 1, 28, 28]                  [-1, 10]               0
=========================================================================================
Total params: 21,840
...
=========================================================================================
            ...
            Conv2d-3         [-1, 64, 224, 224]        [-1, 64, 224, 224]          36,928
              ReLU-4         [-1, 64, 224, 224]        [-1, 64, 224, 224]               0
         MaxPool2d-5         [-1, 64, 224, 224]        [-1, 64, 112, 112]               0
            Conv2d-6         [-1, 64, 112, 112]       [-1, 128, 112, 112]          73,856
              ReLU-7        [-1, 128, 112, 112]       [-1, 128, 112, 112]               0
            Conv2d-8        [-1, 128, 112, 112]       [-1, 128, 112, 112]         147,584
              ReLU-9        [-1, 128, 112, 112]       [-1, 128, 112, 112]               0
        MaxPool2d-10        [-1, 128, 112, 112]         [-1, 128, 56, 56]               0
           Conv2d-11          [-1, 128, 56, 56]         [-1, 256, 56, 56]         295,168
             ReLU-12          [-1, 256, 56, 56]         [-1, 256, 56, 56]               0
           Conv2d-13          [-1, 256, 56, 56]         [-1, 256, 56, 56]         590,080
             ReLU-14          [-1, 256, 56, 56]         [-1, 256, 56, 56]               0
           Conv2d-15          [-1, 256, 56, 56]         [-1, 256, 56, 56]         590,080
             ReLU-16          [-1, 256, 56, 56]         [-1, 256, 56, 56]               0
        MaxPool2d-17          [-1, 256, 56, 56]         [-1, 256, 28, 28]               0
           Conv2d-18          [-1, 256, 28, 28]         [-1, 512, 28, 28]       1,180,160
             ReLU-19          [-1, 512, 28, 28]         [-1, 512, 28, 28]               0
           Conv2d-20          [-1, 512, 28, 28]         [-1, 512, 28, 28]       2,359,808
             ReLU-21          [-1, 512, 28, 28]         [-1, 512, 28, 28]               0
           Conv2d-22          [-1, 512, 28, 28]         [-1, 512, 28, 28]       2,359,808
             ReLU-23          [-1, 512, 28, 28]         [-1, 512, 28, 28]               0
        MaxPool2d-24          [-1, 512, 28, 28]         [-1, 512, 14, 14]               0
           Conv2d-25          [-1, 512, 14, 14]         [-1, 512, 14, 14]       2,359,808
             ReLU-26          [-1, 512, 14, 14]         [-1, 512, 14, 14]               0
           Conv2d-27          [-1, 512, 14, 14]         [-1, 512, 14, 14]       2,359,808
             ReLU-28          [-1, 512, 14, 14]         [-1, 512, 14, 14]               0
           Conv2d-29          [-1, 512, 14, 14]         [-1, 512, 14, 14]       2,359,808
             ReLU-30          [-1, 512, 14, 14]         [-1, 512, 14, 14]               0
        MaxPool2d-31          [-1, 512, 14, 14]           [-1, 512, 7, 7]               0
AdaptiveAvgPool2d-32            [-1, 512, 7, 7]           [-1, 512, 7, 7]               0
           Linear-33                [-1, 25088]                [-1, 4096]     102,764,544
             ReLU-34                 [-1, 4096]                [-1, 4096]               0
          Dropout-35                 [-1, 4096]                [-1, 4096]               0
           Linear-36                 [-1, 4096]                [-1, 4096]      16,781,312
             ReLU-37                 [-1, 4096]                [-1, 4096]               0
          Dropout-38                 [-1, 4096]                [-1, 4096]               0
           Linear-39                 [-1, 4096]                [-1, 1000]       4,097,000
              VGG-40          [-1, 3, 224, 224]                [-1, 1000]               0
=========================================================================================
...
-----------------------------------------------------------------------------------------
        Layer (type)                Input Shape              Output Shape         Param #
=========================================================================================
            Conv2d-1            [-1, 1, 16, 16]           [-1, 1, 16, 16]              10
              ReLU-2            [-1, 1, 16, 16]           [-1, 1, 16, 16]               0
            Conv2d-3            [-1, 1, 28, 28]           [-1, 1, 28, 28]              10
              ReLU-4            [-1, 1, 28, 28]           [-1, 1, 28, 28]               0
        SimpleConv-5            [-1, 1, 16, 16] [[-1, 1, 16, 16], [-1, 1, 28, 28]]      0
=========================================================================================
Total params: 20
Trainable params: 20
Non-trainable params: 0
